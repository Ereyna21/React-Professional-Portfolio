  ...
  return (
    <main className="contact-page">
      <section className="page-heading">
        ...
        <p>
          I am open to conversations about technical support, IT support,
          application support, customer success, product support, and junior
      ...
      <section className="contact-layout">
        <article className="contact-intro-card">
          ...
          <p>
            Send a message with a little context about the opportunity or
            project. I value clear communication and will respond as soon as I
            can.
          </p>
        ...
        >
          ...
          {status === "error" && (
            <p className="form-status error">
              The message could not be sent. Please connect with me through
              LinkedIn.
            </p>
          )}
        </form>
